...
const iconMap = { TrendingUp, Zap, Globe, BadgeCheck };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {features.map((feat) => {
            ...
            return (
              <div
                key={feat.title}
                className="group relative bg-[#13151b] border border-white/10 rounded-xl p-8 hover:border-[#00d4ff]/40 transition-colors"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-11 h-11 rounded-lg bg-[#00d4ff]/10 flex items-center justify-center">
                    {Icon && <Icon className="w-6 h-6 text-[#00d4ff]" strokeWidth={2.2} />}
                  </div>
